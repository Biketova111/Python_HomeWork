...
for i in range(bushes):
    ...
    berries.append(i)
print(f'Колличество ягод на кустах: {berries}')
...
print(berries_count)
print(f'Максимальное число ягод, которое может собрать за один заход собирающий модуль равно {max(berries_count)}')
